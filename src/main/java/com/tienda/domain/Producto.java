...
public class Producto implements Serializable { //serializacion porque se va almacenar ciertos datos en el disco
    ...
    //private long idCategoria;  //ya no necesitamos esta parte porque abajo en Categoria categoria; lo estamos llamando
    ...
    @ManyToOne
    @JoinColumn(name="id_categoria") //esta es la union con la tabla de productos, que es el foreign key
